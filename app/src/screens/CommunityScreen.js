...
export default function CommunityScreen() {
  ...
  const quickLinks = useMemo(() => {
    ...
    return [
      { id: "neighborhood", label: "Neighborhood", subtitle: "Posts, polls and follows across nearby societies", icon: "chatbubbles", color: "#0F6E56", screen: "Neighborhood", roles: ["resident", "admin"] },
