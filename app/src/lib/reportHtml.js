...
export function buildWingReportHtml(report) {
  ...
  const filename = `GateMate-${esc(society?.name).replace(/[^A-Za-z0-9]/g, "")}-${String(wing).replace(/[^A-Za-z0-9]/g, "")}-report`;
...
<body>
  <div class="wrap">
    ...
    <div class="footer">System-generated by GateMate. For society records & backup.</div>
  </div>
</body>
</html>`;
