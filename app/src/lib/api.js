...
export const api = {
  ...
  acceptFollow: (id) => request(`/api/neighborhood/follow/${id}/accept`, { method: "POST" }),
  neighborhoodMessages: (userId) => request(`/api/neighborhood/messages/${userId}`),
  sendNeighborhoodMessage: (userId, body) => request(`/api/neighborhood/messages/${userId}`, { method: "POST", body: { body } }),
