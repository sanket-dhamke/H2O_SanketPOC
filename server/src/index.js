...
import { neighborhoodRouter, ensureNeighborhoodTables } from "./routes/neighborhood.js";
...
app.listen(PORT, "0.0.0.0", () => {
  ...
  ensureNeighborhoodTables().catch((e) => console.error("Neighborhood tables failed:", e.message));
